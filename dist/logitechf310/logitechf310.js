...
var logitechf310 = /** @class */ (function () {
    function logitechf310(config, logger, mixerFactory) {
        var _this = this;
        this.config = config;
        this.logger = logger;
    ...
    Object.defineProperty(logitechf310.prototype, "connected", {
        get: function () {
    ...
    logitechf310.prototype.subscribe = function (i) {
        i.change(this._connected);
        this._connectionEmitter.on('change', i.change);
    };
    logitechf310.prototype.unsubscribe = function (i) {
        this._connectionEmitter.removeListener('change', i.change);
    };
    logitechf310.prototype.dispose = function () {
        this.pad.stop();
    };
    logitechf310.prototype.changeConnection = function (direction) {
        var _a;
    ...
    logitechf310.prototype.specialFunction = function (key) {
        var _a, _b;
...
//# sourceMappingURL=logitechf310.js.map